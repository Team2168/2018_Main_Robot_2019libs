...
public class DriveXUntilCube extends Command{
	 ...
	 */
	public DriveXUntilCube(double distance) {
	...
	public DriveXUntilCube(double distance, double speed) {
		this(distance);
		this.speed = speed;
	}
	...
	public DriveXUntilCube(double distance, double speed, double error) {
		this(distance, speed);
		this.error = error;
	}
...
//		Robot.drivetrain.rotateDriveStraightController.setdGain(RobotMap.ROTATE_POSITION_D_Drive_Straight);
	...
	protected boolean isFinished() {
		return Robot.drivetrain.driveTrainPosController.isFinished() || Robot.cubeIntakeWheels.isCubePresent();
	}
