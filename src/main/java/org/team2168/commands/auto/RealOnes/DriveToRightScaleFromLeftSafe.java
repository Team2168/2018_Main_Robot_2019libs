 ...
 *
 */
public class DriveToRightScaleFromLeftSafe extends CommandGroup {

    public DriveToRightScaleFromLeftSafe() {
    	...
    	addSequential(new DrivePIDPathQuintic(Robot.leftVelPathQuintic11, Robot.rightVelPathQuintic11, Robot.headingQuintic11));
    }
}
