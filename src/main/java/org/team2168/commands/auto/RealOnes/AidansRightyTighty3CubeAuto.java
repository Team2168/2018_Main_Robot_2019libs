 ...
 *
 */
public class AidansRightyTighty3CubeAuto extends CommandGroup {

    public AidansRightyTighty3CubeAuto() {
    	...
    	addSequential(new DriveXDistance(2.7, 1.0));
    	...
    	addParallel(new  DrivePIDPathQuintic(-30, -150, 2500, 3000, 30000));//rotate A to B
    	addParallel(new PivotIntakeDown());
    	...
    	addParallel(new PivotIntakeDown());
    	addSequential(new DriveIntakeWheelsWithConstant(-0.40), 0.3);
    	//addParallel(new OpenIntake());
